    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if 'bbox' in ann:  # add by hui
                ...
                #    x7, y7, w7, h7 = 0, 0, 0, 0
                #    x8, y8, w8, h8 = 0, 0, 0, 0
                   #print(ann['bbox'],ann['id'])
                   #x0, y0, w0, h0 = ann['bbox'][0]
                   x0 = ann['bbox'][0][0]
                   y0 = ann['bbox'][0][1]
                   w0 = ann['bbox'][0][2]
                   h0 = ann['bbox'][0][3]
                ...
                #    w0 = ann['bbox'][2]
                #    h0 = ann['bbox'][3]
                   bbox [0] = [x0, y0, x0 + w0, y0 + h0]
                    #true_bboxes.append(ann['true_bbox'])  
                   #x1, y1, w1, h1 = ann['bbox'][1]
                   x1 = ann['bbox'][1][0]
                   y1 = ann['bbox'][1][1]
                   w1 = ann['bbox'][1][2]
                   h1 = ann['bbox'][1][3]
                   bbox[1] = [x1, y1, x1 + w1, y1 + h1]
                   #x2, y2, w2, h2 = ann['bbox'][2]
                   x2 = ann['bbox'][2][0]
                   y2 = ann['bbox'][2][1]
                   w2 = ann['bbox'][2][2]
                   h2 = ann['bbox'][2][3]
                   bbox [2] = [x2, y2, x2 + w2, y2 + h2]  # add by wzy
                   x3 = ann['bbox'][3][0]
                   y3 = ann['bbox'][3][1]
                   w3 = ann['bbox'][3][2]
                   h3 = ann['bbox'][3][3]
                   bbox [3] = [x3, y3, x3 + w3, y3 + h3]
                   x4 = ann['bbox'][4][0]
                   y4 = ann['bbox'][4][1]
                   w4 = ann['bbox'][4][2]#data[key] = results[key]
                   h4 = ann['bbox'][4][3]
                   bbox [4] = [x4, y4, x4 + w4, y4 + h4]
                   x5 = ann['bbox'][5][0]
                   y5 = ann['bbox'][5][1]
                   w5 = ann['bbox'][5][2]
                   h5 = ann['bbox'][5][3]
                   bbox [5] = [x5, y5, x5 + w5, y5 + h5]
                #    x6 = ann['bbox'][6][0]
                #    y6 = ann['bbox'][6][1]
                #    w6 = ann['bbox'][6][2]
                #    h6 = ann['bbox'][6][3]
                #    bbox [6] = [x6, y6, x6 + w6, y6 + h6]
                #    x7 = ann['bbox'][7][0]
                #    y7 = ann['bbox'][7][1]
                #    w7 = ann['bbox'][7][2]
                #    h7 = ann['bbox'][7][3]
                #    bbox [7] = [x7, y7, x7 + w7, y7 + h7]
                #    x8 = ann['bbox'][8][0]
                #    y8 = ann['bbox'][8][1]
                #    w8 = ann['bbox'][8][2]
                #    h8 = ann['bbox'][8][3]
                #    bbox [8] = [x8, y8, x8 + w8, y8 + h8]'''
            #x1, y1, w, h = ann['bbox']
            ...
            if ann.get('iscrowd', False):
                gt_bboxes_ignore.append(ann['true_bbox'])   #gt_bboxes_ignore.append(gt_bboxes[i]) (coco dataset)
            else:
                gt_bboxes.append(bbox[0]) # add by wzy
                gt_bboxes.append(bbox[1])
                gt_bboxes.append(bbox[2])
                gt_bboxes.append(bbox[3])
                gt_bboxes.append(bbox[4])
                gt_bboxes.append(bbox[5])
                # gt_bboxes.append(bbox[6])
                # gt_bboxes.append(bbox[7])
                # gt_bboxes.append(bbox[8])
                gt_labels.append(self.cat2label[ann['category_id']])
                if 'segmentation'  in ann:
                    gt_masks_ann.append(ann['segmentation'][0])  
                    gt_masks_ann.append(ann['segmentation'][1])  
                    gt_masks_ann.append(ann['segmentation'][2])  
                    gt_masks_ann.append(ann['segmentation'][3])  
                    gt_masks_ann.append(ann['segmentation'][4])  
                    gt_masks_ann.append(ann['segmentation'][5])  
                    # gt_masks_ann.append(ann['segmentation'][6])  
                    # gt_masks_ann.append(ann['segmentation'][7]) 
                ...
                if ann['area'] <= 0 or w < 1 or h < 1:
                    continue
                #    x0, y0, w0, h0 = ann['true_bbox'][0]
                #    true_bboxes.append([x0, y0, x0 + w0, y0 + h0])
                #     #true_bboxes.append(ann['true_bbox'])  
                #    x1, y1, w1, h1 = ann['true_bbox'][1]
                #    true_bboxes.append([x1, y1, x1 + w1, y1 + h1])
                #    x2, y2, w2, h2 = ann['true_bbox'][2]
                #    true_bboxes.append([x2, y2, x2 + w2, y2 + h2])  # add by wzy
